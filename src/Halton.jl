...
"""
function HaltonSeq!{T<:AbstractFloat}(H::Vector{T}, B::Int; skip::Int=500)
...
Keyword argument `skip` is the number initial "burn-in" elements to drop.
"""
function HaltonDraws!{T<:AbstractFloat}(H::Vector{T}, B::Int; skip::Int=500, distr = Normal())
...
function H!{T<:AbstractFloat, I<:Signed}(H::Vector{T}, b::I)
